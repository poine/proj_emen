...
ext = Extension(
    "pm_cpp_ext",      # name of extension
    ["pm_cpp_ext.pyx"],  # filename of our Pyrex/Cython source
    language="c++",    # this causes Pyrex/Cython to create C++ source
    include_dirs=["/home/poine/work/proj_emen/src/native/", '/opt/ros/melodic/include/'],
    extra_compile_args=["-std=c++11", "-Wno-cpp"],
    libraries=["pm"],
    library_dirs=["/opt/ros/melodic/lib/", "/home/poine/work/proj_emen/src/native/"],
